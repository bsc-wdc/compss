...
public class GetObjectPipeCommand extends GetObjectExternalCommand implements PipeCommand {
    ...
    public int compareTo(PipeCommand t) {
        ...
        if (val == 0) {
            val = this.getObjectId().compareTo(((GetObjectExternalCommand) t).getObjectId());
        }
        return val;
    }
