...
def wrroc_create_action(
    ...
    if host_name is not None:
        create_action_properties["location"] = host_name
    ...
    try:
        ...
        if __debug__:
            print(f"PROVENANCE DEBUG | RO-Crate adding statistical data")
    ...
    if os.path.isdir(energy_path):
        try:
            ...
            if __debug__:
                print("PROVENANCE DEBUG | EAR not used")
    else:
        if __debug__:
            print("PROVENANCE DEBUG | EAR not enabled")
