...
public class Constants {
    ...
    public static final String MONITOR_CURRENT_DOT_FILE =
        File.separator + "monitor" + File.separator + "current_graph.dot";
    public static final String MONITOR_COMPLETE_DOT_FILE =
        File.separator + "monitor" + File.separator + "complete_graph.dot";
    ...
    public static final String GRAPH_EXECUTION_DONE_PATH =
        File.separator + "svg" + File.separator + "graph_execution_done.svg";
    public static final String NO_CONNECTION_IMG_PATH =
        File.separator + "compss-monitor" + File.separator + "svg" + File.separator + "loadGraphNoConnection.png";
    public static final String COMPSS_MONITOR_DEFAULT =
        File.separator + "root" + File.separator + ".COMPSs" + File.separator;
