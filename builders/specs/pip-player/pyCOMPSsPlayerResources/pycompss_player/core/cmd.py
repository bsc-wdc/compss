...
def docker_deploy_compss(working_dir: str = "",
                         image: str = "",
...
def docker_kill_compss(clean: bool = True) -> None:
...
def docker_exec_in_daemon(cmd: str) -> None:
...
def docker_start_monitoring() -> None:
...
def docker_stop_monitoring() -> None:
...
def docker_components(option: str = "list",
                      resource: str = "worker",
                      value: str = "1") -> None:
...
def _get_mounts(user_working_dir: str) -> list:
...
def _generate_resources_cfg(ips: list = (), cpus: int = 4) -> str:
...
def _update_cfg(master, cfg: dict, ips, cpus) -> None:
...
def _add_custom_worker(custom_cfg: str) -> None:
...
def _remove_custom_worker(custom_cfg: str) -> None:
