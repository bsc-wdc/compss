...
public class Verifiers {
	...
	public static void verifyScore(DefaultScore ds, long action, long data, long res, long impl, long start) {
		...
		if (data != ds.getExpectedDataAvailable()) {
			System.out.println("Scores do not match. Expected data available at " + data + " and " + ds.getExpectedDataAvailable()
					+ " obtianed.");
		...
		if (impl != ds.getImplementationScore()) {
			System.out.println("Scores do not match. Expected implementation score " + impl + " and " + ds.getImplementationScore()
					+ " obtianed.");
