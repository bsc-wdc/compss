...
public abstract class Resource implements Comparable<Resource> {
    ...
    /**
     * Returns the Resource associated to the given name @name
     * Null if any resource has been registered with the name @name
     * 
     * @param name
     * @return
     */
    ...
    private void getTracingPackageToMaster() {
        ...
        if (debug) {
            logger.debug("Copying tracing package from : " + fileOriginURI.getPath() 
            		+ ",to : " + Comm.appHost.getAppLogDirPath() + "trace" + File.separator + fileName);
        }
