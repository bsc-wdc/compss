...
public class DeleteFilePipeCommand extends DeleteFileExternalCommand implements PipeCommand {
    ...
    public int compareTo(PipeCommand t) {
        ...
        if (val == 0) {
            val = this.getFile().compareTo(((DeleteFileExternalCommand) t).getFile());
        }
        return val;
    }
