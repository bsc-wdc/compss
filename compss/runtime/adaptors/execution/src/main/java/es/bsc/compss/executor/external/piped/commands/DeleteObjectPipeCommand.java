...
public class DeleteObjectPipeCommand extends DeleteObjectExternalCommand implements PipeCommand {
    ...
    public int compareTo(PipeCommand t) {
        ...
        if (val == 0) {
            val = this.getObjectId().compareTo(((DeleteObjectExternalCommand) t).getObjectId());
        }
        return val;
    }
