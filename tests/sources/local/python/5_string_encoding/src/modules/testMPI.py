...
@mpi(runner="mpirun", processes="1", binary="./checkString.sh", working_dir=os.getcwd() + '/src/scripts/')
...
@mpi(runner="mpirun", processes="1", binary="./failFirstTime.sh", working_dir=os.getcwd() + '/src/scripts/', fail_by_exit_value=True)
...
class testMPI(unittest.TestCase):
    ...
    def testMPIBasicMultipletimes(self):
        times = 10
        param = "testing string"
        expected = [0] * times
        result = []
