...
public class ResourcesFile {
     ...
     * **************************************/
    /**
     * Creates a ResourceFile instance from a given XML file. The XML is
    ...
    /**
     * Creates a ResourceFile instance from a given XML string. The XML is
     * validated against the given schema and internally validated
     *
     * @param xmlString
     * @param xsd
    ...
    /**
     * Returns a HashMap of declared Shared Disks (Key: Name, Value:
     * List<Services>)
     *
     * @return
     */
    ...
    /**
     * Returns the instance with the given name within the given CloudProvider.
     * Null if not found
     *
     * @param cp
     * @param instanceName
    ...
    /**
     * Returns the image with the given name within the given CloudProvider.
     * Null if not found
     *
     * @param cp
     * @param imageName
    ...
    /**
     * Adds a new SharedDisk with name=@name and storage=@storage and returns
     * the instance of the new SharedDisk
     *
     * @param name
     * @param storage
     * @return
