...
public class ExecutionInformationTask {
	...
	public class Job {
		...
		public Job(String id) {
			...
			this.color = new String(File.separator + "images" + File.separator + "state" + File.separator + Constants.COLOR_TASK_CREATING
					+ ".jpg");
		...
		public void setStatus(String status) {
			if (status.equals(Constants.STATUS_TASK_CREATING)) {
				this.status = status;
				this.setColor(File.separator + "images" + File.separator + "state" + File.separator + Constants.COLOR_TASK_CREATING
						+ ".jpg");
			} else if (status.equals(Constants.STATUS_TASK_RUNNING)) {
				this.status = status;
				this.setColor(File.separator + "images" + File.separator + "state" + File.separator + Constants.COLOR_TASK_RUNNING + ".jpg");
