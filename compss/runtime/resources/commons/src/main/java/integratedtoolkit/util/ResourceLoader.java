...
public class ResourceLoader {
	...
	private static void loadRuntime() throws NoResourceAvailableException {
		...
		/* ***************************************************************
		 * Resources and project have been loaded and validated We need to cross validate them and load the information
		 * in the runtime
		 * 
		...
		if (computeNodes != null) {
			for (ComputeNodeType cn_project : computeNodes) {
				integratedtoolkit.types.resources.jaxb.ComputeNodeType cn_resources = ResourceLoader.resources.getComputeNode(cn_project
						.getName());
		...
		if (dataNodes != null) {
			for (DataNodeType dn_project : dataNodes) {
				integratedtoolkit.types.resources.jaxb.DataNodeType dn_resources = ResourceLoader.resources.getDataNode(dn_project
						.getName());
