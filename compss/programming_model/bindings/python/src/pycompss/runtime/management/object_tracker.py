...
class ObjectTracker(object):
    ...
    def get_objid_to_filename_values(self):
        return self.objid_to_filename.values()

    def get_objid_to_filename(self, obj_id):
        return self.objid_to_filename.get(obj_id)

    def set_objid_to_filename(self, obj_id, filename):
        self.objid_to_filename[obj_id] = filename

    def pop_objid_to_filename(self, obj_id):
        return self.objid_to_filename.pop(obj_id)

    def get_all_pending_to_synchronize(self):
        return self.pending_to_synchronize
    ...
    def get_all_objs_written_by_mp(self):
        return self.objs_written_by_mp

    def set_objs_written_by_mp(self, obj_id, filename):
        self.objs_written_by_mp[obj_id] = filename

    def pop_objs_written_by_mp(self, obj_id):
