...
public class RegisterRemoteFileDataRequest extends APRequest {
     ...
     * @param loc location of the file to register
     * @param data Existing LogicalData to bind the value access.
     */
    public RegisterRemoteFileDataRequest(Application app, DataLocation loc, String data) {
        this.app = app;
        this.loc = loc;
        this.data = data;
    }
    ...
    public void process(AccessProcessor ap, TaskAnalyser ta, DataInfoProvider dip, TaskDispatcher td)
        ...
        dip.registerRemoteFileSources(app, loc, data);
    }
