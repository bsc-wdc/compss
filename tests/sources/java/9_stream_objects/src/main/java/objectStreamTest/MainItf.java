...
public interface MainItf {
    ...
    void writeObjects(
        //@Parameter(type = Type.STREAM, direction = Direction.OUT) ObjectDistroStream ods,
        @Parameter(type = Type.OBJECT, direction = Direction.IN) ObjectDistroStream<MyObject> ods,
    ...
    @Method(declaringClass = "objectStreamTest.Tasks")
    Integer readObjects(
        //@Parameter(type = Type.STREAM, direction = Direction.IN) ObjectDistroStream ods,
        @Parameter(type = Type.OBJECT, direction = Direction.IN) ObjectDistroStream<MyObject> ods,
        @Parameter() int sleepTime
    );
