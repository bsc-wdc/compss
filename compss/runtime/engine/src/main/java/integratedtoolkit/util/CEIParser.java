...
public class CEIParser {
     ...
     */
    private static void loadMethodConstraints(int coreId, int implementationCount, String[] declaringClasses,
    ...
    public static int parseIDLMethods(LinkedList<Integer> updatedMethods, HashMap<Integer, MethodImplementation> readMethods,
    ...
    private static void parseCFunction(String line, LinkedList<Integer> updatedMethods, HashMap<Integer, MethodImplementation> readMethods,
            MethodResourceDescription currConstraints) {
        StringBuilder buffer = new StringBuilder();
