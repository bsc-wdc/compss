...
public class ProjectFile {
	 ...
	 * **************************************/	
	/**
	 * Creates a ProjectFile instance from a given XML file.
	...
	/**
	 * Creates a ProjectFile instance from a given XML string.
	 * The XML is validated against the given schema and internally validated
	 * 
	 * @param xmlString
	 * @param xsd
	...
	/**
	 * Returns the instance of the MasterNode. 
	 * Null if not found (but XSD schema doesn't allow it)
	 * @return
	 */
	...
	public CloudType addCloud(List<CloudProviderType> cps) throws InvalidElementException {
		...
		if (cps != null) {
			for (CloudProviderType cp : cps) {
				JAXBElement<CloudProviderType> cp_jaxb =  new JAXBElement<CloudProviderType> (new QName("CloudProvider"), CloudProviderType.class, cp);
	 ...
	 * Returns true if all modifications have been performed, false otherwise
	 * 
	 * @param initialVMs
	 * @param minVMs
	 * @param maxVMs
