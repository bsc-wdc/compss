...
public interface ServicesTestItf {
    ...
    public void print(@Parameter(direction = Direction.IN) Person p);
    ...
    @Service(name = "GroupService", namespace = "http://groupService", port = "GroupServicePort")
    public Person getWorker(@Parameter(direction = Direction.IN) int id);

    @Service(name = "GroupService", namespace = "http://groupService", port = "GroupServicePort")
    public double productivity();

    @Service(name = "GroupService", namespace = "http://groupService", port = "GroupServicePort")
    public void setNumWorkers(@Parameter(direction = Direction.IN) int numWorkers);

    @Service(name = "GroupService", namespace = "http://groupService", port = "GroupServicePort")
    public void setWorker(@Parameter(direction = Direction.IN) Person worker,
