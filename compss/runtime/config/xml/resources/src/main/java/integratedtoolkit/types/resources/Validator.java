...
public class Validator {
	...
	/**
	 * Validates the given ComputeNodeType @cn with the current ResourcesFileType
	 * The content is correct if no exception is raised
	 * 
	 * @param cn
	 * @throws InvalidElementException
	...
	/**
	 * Validates the given ServiceType @s with the current ResourcesFileType
	 * The content is correct if no exception is raised
	 * 
	 * @param s
	 * @throws InvalidElementException
	...
	/**
	 * Validates the given CloudProviderType @cp with the current ResourcesFileType
	 * The content is correct if no exception is raised
	 * 
	 * @param cp
	 * @throws InvalidElementException
