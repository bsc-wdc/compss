 ...
 * @param <T>
 */
public class LIFOScheduler<P extends Profile, T extends WorkerResourceDescription> extends ReadyScheduler<P, T> {
    ...
    public ResourceScheduler<P, T>[] getWorkers() {
        synchronized (workers) {
            ...
            LIFOResourceScheduler<P, T>[] scheds = new LIFOResourceScheduler[resScheds.size()];
