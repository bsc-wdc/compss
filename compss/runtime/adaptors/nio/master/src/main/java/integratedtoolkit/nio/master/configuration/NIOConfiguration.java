...
public class NIOConfiguration extends MethodConfiguration {
    ...
    public static final List<String> AVAILABLE_REMOTE_EXECUTION_COMMANDS = Arrays.asList(
    		new String[]{ SSH_REMOTE_EXECUTION_COMMAND, 
    				SRUN_REMOTE_EXECUTION_COMMAND, 
    				BLAUNCH_REMOTE_EXECUTION_COMMAND,
    				QRSH_REMOTE_EXECUTION_COMMAND, NO_REMOTE_EXECUTION_COMMAND});
