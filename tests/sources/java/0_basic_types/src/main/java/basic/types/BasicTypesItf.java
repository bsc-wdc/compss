...
public interface BasicTypesItf {
    ...
    void testBasicTypes(@Parameter(type = Type.FILE, direction = Direction.OUT) String file,
        ...
        @Parameter(type = Type.SHORT) short sh, @Parameter(type = Type.INT) int i,
        // Direction not mandatory for basic types, default=IN
        @Parameter(type = Type.LONG, direction = Direction.IN) long l, @Parameter(type = Type.FLOAT) float f,
