...
public class TestJavaInvoker extends TestObject {
    ...
    static {
        TEST_EMPTY = new MethodImplementation(EXISTING_CLASS, TEST_EMPTY_METHODNAME, 0, 0, new MethodResourceDescription());
        TEST_READS = new MethodImplementation(EXISTING_CLASS, TEST_READS_METHODNAME, 0, 0, new MethodResourceDescription());
        TEST_INOUT = new MethodImplementation(EXISTING_CLASS, TEST_INOUT_METHODNAME, 0, 0, new MethodResourceDescription());
        TEST_TARGET_IN = new MethodImplementation(EXISTING_CLASS, TEST_TARGET_IN_METHODNAME, 0, 0, new MethodResourceDescription());
    ...
    public void parameterMissmatch() throws InvalidMapException, IOException, JobExecutionException {
        ...
        InvocationParam p1 = new FakeInvocationParam(DataType.OBJECT_T, "", "none", Stream.UNSPECIFIED, "", renaming1, false);
        params.add(p1);
        ...
        InvocationParam p2 = new FakeInvocationParam(DataType.OBJECT_T, "", "none", Stream.UNSPECIFIED, "", renaming2, false);
        params.add(p2);
    ...
    public void inoutsTest() throws InvalidMapException, IOException, JobExecutionException {
        ...
        String renaming1 = "d5v3_754478989756456.IT";
        Object value1 = new TestObject(3);
        InvocationParam p1 = new FakeInvocationParam(DataType.OBJECT_T, "", "none", Stream.UNSPECIFIED, "", renaming1, true);
        params.add(p1);
        expectedEvents.add(Event.Type.GET_OBJECT, renaming1, value1);
        String renaming2 = "d6v3_754478989756456.IT";
        Object value2 = new TestObject(2);
        InvocationParam p2 = new FakeInvocationParam(DataType.OBJECT_T, "", "none", Stream.UNSPECIFIED, "", renaming2, true);
        params.add(p2);
        expectedEvents.add(Event.Type.GET_OBJECT, renaming2, value2);
        invBr = invBr.setParams(params);
        Invocation invocation = invBr.build();
