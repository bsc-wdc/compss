...
public class ReduceImplementation extends AbstractMethodImplementation implements Externalizable {
    ...
    /**
     * Creates a new ReduceImplementation instance for serialization.
     */
    public ReduceImplementation() {
        // For externalizable
        super();
    }

    /**
     * Creates a new ReduceImplementation from the given parameters.
     *
     ...
     */
    public ReduceImplementation(String methodClass, String methodName, Integer coreId, Integer implementationId,
