...
public class ITAppLoader {
	...
	protected static void load(String chosenLoader, String appName, String[] appArgs) throws Exception {
		 ...
		 * - Custom loader: to load our javassist version classes and the classes that use them. 
		 * - System loader: parent of the custom loader, it will load the rest of the classes (including the
