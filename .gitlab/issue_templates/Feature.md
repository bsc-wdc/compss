...
Before opening a new issue, make sure to search for keywords in the issues filtered by the "regression" or "type::feature" label and verify the issue you're about to submit isn't a duplicate.
-->
...
Please describe the documentation changes.

* [ ] I have added a documentation branch:
...
* [ ] The code has been reviewed by at least 1 person
