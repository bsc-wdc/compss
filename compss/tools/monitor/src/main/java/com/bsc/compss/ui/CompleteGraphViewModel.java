...
public class CompleteGraphViewModel {
	...
	public void download() {
		try {
			if ((completeGraph.equals(Constants.GRAPH_NOT_FOUND_PATH)) || (completeGraph.equals(Constants.GRAPH_EXECUTION_DONE_PATH))
	...
	private String loadGraph(String location, String target) throws Exception {
		...
		String[] createSVG = {
				"/bin/sh",
				"-c",
				"dot -T svg " + location + " > " + System.getProperty("catalina.base") + File.separator + "webapps" + File.separator
