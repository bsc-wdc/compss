...
public class Validator {
    ...
    /**
     * Validates the content of the given ResourcesFile object The content is
     * correct if no exception is raised
     *
     ...
     * **********************************************/
    /**
     * Validates the given SharedDiskType @sd with the current ResourcesFileType
    ...
    /**
     * Validates the given DataNodeType @dn with the current ResourcesFileType
     * The content is correct if no exception is raised
     *
     * @param dn
     * @throws InvalidElementException
    ...
    /**
     * Validates the given ComputeNodeType @cn with the current
     * ResourcesFileType The content is correct if no exception is raised
     *
     * @param cn
     * @throws InvalidElementException
     */
    ...
    /**
     * Validates the given ServiceType @s with the current ResourcesFileType The
     * content is correct if no exception is raised
     *
     * @param s
     * @throws InvalidElementException
     */
    ...
    /**
     * Validates the given CloudProviderType @cp with the current
     * ResourcesFileType The content is correct if no exception is raised
     *
     * @param cp
     * @throws InvalidElementException
