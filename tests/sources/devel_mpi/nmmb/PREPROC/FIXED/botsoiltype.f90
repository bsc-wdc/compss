...
character*256 input_seamaskDEM, input_soiltype_path, output_botsoiltype

if (command_argument_count().gt.0) then
  call get_command_argument(1,input_seamaskDEM,length,stat)
  call get_command_argument(2,input_soiltype_path,length,stat)
  call get_command_argument(3,output_botsoiltype,length,stat)
end if
...
!-----------------------------------------------------------------------
          infile = trim(input_soiltype_path) // fname 
...
!-----------------------------------------------------------------------
      ...
      enddo
!-----------------------------------------------------------------------
      outfile = output_botsoiltype
      open(unit=1,file=outfile,status='unknown' &
          ,form='unformatted')
      write(1) ltype
      close(1)
      print*,'botsoiltype file written to ../output/botsoiltype'
      print*,'Enjoy your bottom soil type!'
!-----------------------------------------------------------------------
endprogram botsoiltype
!-----------------------------------------------------------------------
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
