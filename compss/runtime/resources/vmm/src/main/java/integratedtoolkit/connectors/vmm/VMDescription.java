...
public class VMDescription extends VMRequest {
	...
	public VMDescription(JSONObject jsonObject) throws JSONException {
		super((String) jsonObject.get("name"), (String) jsonObject.get("image"), (int) jsonObject.get("cpus"), (int) jsonObject
				.get("ramMb"), (int) jsonObject.get("diskGb"), (String) jsonObject.get("applicationId"));
