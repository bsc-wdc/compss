    ...
    *output = stdout ;
    ...
    for (i=1; i<argc; i++)
        if (argv[i][0] == '-') {
            if (strcmp(argv[i],"-l")   == 0)
            ...
            else if (strcmp(argv[i],"-strides")   == 0)
            ...
            else if (strcmp(argv[i],"-otl") == 0)
                cloog_options_set(&(*options)->otl,argc,argv,&i) ;
            else if (strcmp(argv[i],"-openscop") == 0) {
#ifdef OSL_SUPPORT
                (*options)->openscop = 1 ;
#else
            ...
            else if (strcmp(argv[i],"-loopo") == 0) { /* Special option for the LooPo team ! */
                (*options)->esp   = 0 ;
                (*options)->block = 1 ;
            } else if (strcmp(argv[i],"-bipbip") == 0) /* Special option for the author only !*/
                (*options)->backtrack = 0;
                ...
                (*options)->override = 1 ;
            else if (strcmp(argv[i],"-noblocks") == 0)
                (*options)->noblocks = 1 ;
            else if (strcmp(argv[i],"-noscalars") == 0)
                (*options)->noscalars = 1 ;
            else if (strcmp(argv[i],"-nosimplify") == 0)
                (*options)->nosimplify = 1 ;
            else if ((strcmp(argv[i],"-struct") == 0) || (strcmp(argv[i],"-structure") == 0))
                (*options)->structure = 1 ;
