...
python_path = './bindings/python/src/pycompss/api/data_type.py'

notification = 'Autogenerated file (see generate_datatype.py). Used DataType.java as the source template'
...
with open(python_path, 'w') as f:
    f.write('# %s \n \n' % notification)
    f.write('class data_type(object):\n')
