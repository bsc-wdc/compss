...
public interface TracingBackend {
    ...
    /**
     * Returns the configuration that a worker needs to push events to the same tracing system.
     * 
     * @return configuration to be used by the remote worker
     */
    String getWorkerTracingConfiguration();
}
