...
public abstract class AllocatableAction<P extends Profile, T extends WorkerResourceDescription> {
	...
	public abstract void schedule(ResourceScheduler<P, T> targetWorker, Score actionScore) throws BlockedActionException,
			UnassignedActionException;

	public abstract void schedule(ResourceScheduler<P, T> targetWorker, Implementation<T> impl) throws BlockedActionException,
			UnassignedActionException;
