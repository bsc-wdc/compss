...
public class DictCollectionFetchOperationsListener extends MultiOperationFetchListener {
    ...
    public DictCollectionFetchOperationsListener(String dictCollectionDataId, FetchDataListener listener) {
        this.dictCollectionDataId = dictCollectionDataId;
        this.listener = listener;
    }

    @Override
    public void doCompleted() {
        this.listener.fetchedValue(this.dictCollectionDataId);
    }

    @Override
    public void doFailure(String failedDataId, Exception e) {
        this.listener.errorFetchingValue(this.dictCollectionDataId, e);
    }
}
