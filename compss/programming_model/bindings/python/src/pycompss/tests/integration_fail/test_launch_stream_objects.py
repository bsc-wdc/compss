...
def test_launch_streaming_application():
    ...
    start_script = os.path.join(
        current_path, "streaming", "start_server.sh"
    )
    ...
    app = os.path.join(current_path, "streaming", "stream_objects.py")
    ...
    stop_script = os.path.join(current_path, "streaming", "stop_server.sh")
